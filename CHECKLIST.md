...
- [ ] Parameter naming and grouping (`param1..N` vs named) before the first preset exists
...
`docs/evidence/amorph-host-tests.md` (to be created with the first result).

- [ ] H1 view instantiated on project load with the window closed?
- [ ] H2 MIDI channel preserved into `midiIn` and out of `midiOut`
...
- [ ] H7 `transportIn` slots and PPQ as in kit doc 14
...
- [ ] Kit recipe `07_SCALING.md` adopted 1:1 and diffed line by line (kit rule 8)
